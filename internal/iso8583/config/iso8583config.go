...
const (
	//FIXED fixed lenght
	FIXED = 0
	//LVAR Dinamic lenght < 10
	LVAR = 1
	//LLVAR Dinamic lenght < 100
	LLVAR = 2
	//LLLVAR Dinamic lenght < 1000
	LLLVAR = 3
)
...
func initFieldConfig() {
	...
	fieldConfiguration[23] = FieldConfiguration{"Application PAN sequence number", N, FIXED, 3}
	...
	fieldConfiguration[34] = FieldConfiguration{"Primary account number, extended", AN, LLLVAR, 28}
	...
	fieldConfiguration[52] = FieldConfiguration{"Personal Identification number data", B, FIXED, 64}
	fieldConfiguration[53] = FieldConfiguration{"Security related control information", N, FIXED, 16}
	...
	fieldConfiguration[64] = FieldConfiguration{"Message authentication code (MAC)", B, FIXED, 64}
	fieldConfiguration[65] = FieldConfiguration{"Extended bitmap indicator, tertiary", B, FIXED, 1}
	...
	fieldConfiguration[72] = FieldConfiguration{"Data record (ISO 8583:1993)/n 4 Message number, last", N, FIXED, 4}
	...
	fieldConfiguration[86] = FieldConfiguration{"Total amount of credits", N, FIXED, 16}
	fieldConfiguration[87] = FieldConfiguration{"Credits, reversal amount", N, FIXED, 16}
	fieldConfiguration[88] = FieldConfiguration{"Total amount of debits", N, FIXED, 16}
	fieldConfiguration[89] = FieldConfiguration{"Debits, reversal amount", N, FIXED, 16}
	...
	fieldConfiguration[96] = FieldConfiguration{"Message security code ", B, FIXED, 64}
	...
	fieldConfiguration[101] = FieldConfiguration{"File name", ANS, LLVAR, 17}
	...
	fieldConfiguration[113] = FieldConfiguration{"Authorizing agent institution id code", ANS, LLLVAR, 999}
	...
	fieldConfiguration[124] = FieldConfiguration{"Reserved for private use", ANS, LLLVAR, 999}
	fieldConfiguration[125] = FieldConfiguration{"Reserved for private use", ANS, LLLVAR, 999}
	fieldConfiguration[126] = FieldConfiguration{"Reserved for private use", ANS, LLLVAR, 999}
	fieldConfiguration[127] = FieldConfiguration{"Reserved for private use", ANS, LLLVAR, 999}
	fieldConfiguration[128] = FieldConfiguration{"Message Authentication code", B, FIXED, 64}
}
